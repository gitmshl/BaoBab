<?php
	...
	*/
	...
	include_once "..\SQL_Functions\Users_Main_Information\SQL_Get.php"; /// для аватарок
	Update();
		...
		<?php
			...
			else
			{
				for ($i = 0; $i < $count; $i++)
				{
					...
					$user_id = $dialog['id_user'];
					$img_path = Get_Avatar_Name_by_User_Id($user_id);
					$img1 = str_replace("\"", "", $img_path);
					$img_path = "..\Files\User_".$user_id."\\".$img1;
					//echo "sdfsdf $img_path <br>";
				?>
					<div class="dialog_block">
						...
						<a href="..\Current_Dialog\current_dialog.php?id=<?=$dialog['id']?>&new_dialog=" class="profile_name_link">
