<?php
	/*
		Этот файл отвечает за поиск друзей НАШЕГО ПОЛЬЗОВАТЕЛЯ, т.е. нашего
	...
	*/
	...
	$Peoples = Get_Friends($_SESSION['User']['id'], $_REQUEST['Local_Search_Line'], $count_peoples);
?>
	...
	<div class="wrapper">
		...
		<div class="people_group_search_middle_content">
			...
			<div class="search_smth_link">
				<a href = "MFS.php" align = "center"  class="underlined">My Friends</a>
				<a href = "RFF.php" id="people">Requests For Friends</a>
			</div>
						...
						else
						{
							...
							<div class="profile_block">
								...
								<div class="profile_name">
									...
									&lastname=<?=$person['LastName']?>&img=<?=$img_main_path?>&request=delete&way=MFS.php">Delete friend</a></div>
									</div>
								</div>
							</div>
							<?php
